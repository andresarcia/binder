...
int main(int argc, char * argv[])
{
  ...
  */
  ...
  Cooperative_Question request;

  group_client.strong_send_to_group(RECEIVE_FROM_GROUP_DAEMON,
				    &request,
				    sizeof(Cooperative_Question));
 
  //  group_client.leave_group(services_thread.get_port());
